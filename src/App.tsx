  ...
  return (
    <div className={`min-h-screen transition-colors duration-100 ${darkMode ? 'dark:bg-gray-900' : 'bg-gray-50'}`}>
      ...
      <section className="relative overflow-hidden py-20 sm:py-32">
        <div className="absolute inset-0 bg-[url('https://raw.githubusercontent.com/RonakRahane/Portfolio-Page/main/images/background.jpeg')] bg-cover bg-center opacity-25 dark:opacity-10"></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="relative group max-w-sm mx-auto cursor-pointer" onClick={handleProfileClick}>
              ...
              <img
                src="https://raw.githubusercontent.com/RonakRahane/Portfolio-Page/main/images/picture.png"
                alt="Profile"
